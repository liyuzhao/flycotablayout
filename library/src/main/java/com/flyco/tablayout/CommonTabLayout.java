...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorColor =
                ta.getColor(R.styleable.CommonTabLayout_tl_indicator_color, Color.parseColor(mIndicatorStyle == STYLE_BLOCK ? "#4B6A87" : "#ffffff"));
        ...
        mIndicatorCornerRadius =
                ta.getDimension(R.styleable.CommonTabLayout_tl_indicator_corner_radius, dp2px(mIndicatorStyle == STYLE_BLOCK ? -1 : 0));
        ...
        mIndicatorMarginBottom =
                ta.getDimension(R.styleable.CommonTabLayout_tl_indicator_margin_bottom, dp2px(mIndicatorStyle == STYLE_BLOCK ? 7 : 0));
        ...
        mDividerColor = ta.getColor(R.styleable.CommonTabLayout_tl_divider_color, Color.parseColor("#cccccc"));
        mDividerWidth = ta.getDimension(R.styleable.CommonTabLayout_tl_divider_width, dp2px(1));
    ...
    private void addTab(final int position, View tabView) {
        ...
        /** 每一个Tab的布局参数 */
        float weight;
        if (tv_tab_title.getText().length() > 3) {
            weight = 1.5f;
        } else {
            weight = 1.0f;
        }

        LinearLayout.LayoutParams lp_tab = mTabSpaceEqual ? new LinearLayout.LayoutParams(0, LayoutParams.MATCH_PARENT, weight)
        ...
        for (int i = 0; i < mTabCount; i++) {
            ...
            if (mIconVisible) {
                ...
                LinearLayout.LayoutParams lp =
                        new LinearLayout.LayoutParams(mIconWidth <= 0 ? LinearLayout.LayoutParams.WRAP_CONTENT : (int) mIconWidth,
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            ImageView ivBaseLine = (ImageView) tabView.findViewById(R.id.iv_tab_icon);
            tab_title.setTextColor(isSelect ? mTextSelectColor : mTextUnselectColor);
            if (getBaseLineId() != 0) {
                ivBaseLine.setImageResource(getBaseLineId());
                float textWith = tab_title.getPaint().measureText(tab_title.getText().toString());
                ViewGroup.LayoutParams params = ivBaseLine.getLayoutParams();
                params.width = (int) textWith;
                ivBaseLine.setScaleType(ImageView.ScaleType.FIT_XY);
                ivBaseLine.setLayoutParams(params);
                if (isSelect) {
                    ivBaseLine.setVisibility(VISIBLE);
                } else {
                    ivBaseLine.setVisibility(GONE);
                }
            }
        }
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIndicatorStyle == STYLE_TRIANGLE) {
            ...
            if (mIndicatorHeight > 0) {
                ...
                mIndicatorDrawable.setBounds(paddingLeft + (int) mIndicatorMarginLeft + mIndicatorRect.left, (int) mIndicatorMarginTop,
            ...
            if (mIndicatorHeight > 0) {
                ...
                if (mIndicatorGravity == Gravity.BOTTOM) {
                    ...
                    mIndicatorDrawable.setBounds(paddingLeft + (int) mIndicatorMarginLeft + mIndicatorRect.left, (int) mIndicatorMarginTop,
                            paddingLeft + mIndicatorRect.right - (int) mIndicatorMarginRight, (int) mIndicatorHeight + (int) mIndicatorMarginTop);
                }
                mIndicatorDrawable.setCornerRadius(mIndicatorCornerRadius);
                mIndicatorDrawable.draw(canvas);
            }
